...
export const CheckoutSection = () => {
    ...
    useEffect(() => {
        ...
        const totalTicket = items.reduce((acc, event) => acc + event.price * event.quantity, 0)
        setTotalTicket(totalTicket)

        const total = totalTicket + 1600
        setTotal(total)
    }, [])
    ...
    <div>
        <section className='container-checkout'>
            <div className='container-cart'>
                <p className='cart-text'>Events:</p>
                ...
                <div className='container-items'>
...

                    {
                        items.map(event => (
                            ...
                            <div className='container-item' key={event._id}>
                                
                                <div className="info">
                                <img src="https://i.postimg.cc/PxJKYqWZ/just4-kitchen.jpg"/>
                                <div className='text-info'>
                                    <p>{event.name}</p>
                                    <span>{event.category} - {event.place}</span>
                                </div>
                                    
                                </div>
                                <strong>quantity: x{event.quantity}</strong>
            ...
            <p className='title-payment'>Payment Details</p>

            <span className='description-payment'>Complete your purchase item by providing your payment detail order</span>
            </div>
                ...
                <form>
                    ...
                    <label htmlFor="email">
                        ...
                        <input className='input-dates' autoComplete='off' placeholder='Example@gmail.com' type="email" name="" id="email" />
                    </div>
                    <div className='container-input'>
                        ...
                        <label htmlFor="email">
                            ...
                            <input className='input-dates' autoComplete='off'  placeholder='sergio' type="email" name="" id="email" />
                    </div>
                    <div className='container-input'>
                        ...
                        <label htmlFor="email">
                            ...
                            <input className='input-dates' autoComplete='off'  placeholder='godoy' type="email" name="" id="email" />
                    </div>
                    <div className='container-input'>
                        ...
                        <label htmlFor="card">
                            ...
                            <input className='input-dates' autoComplete='off' placeholder='5431 5423 2795 1036'  type="text" name="" id="card" />
                    </div>
                        <div className='inputs-card'>
                            <div>
                                ...
                                <input type="text" autoComplete='off' placeholder='07/27' />
                            </div>
                            <div>
                ...
                <div className='container-detail-payment'>
                    <p className='price-detail'>Price Details:({items.length} item)</p>
                ...
                <button style={{backgroundColor: `${btnText === "Purchase Completed!" && "#00a650"}`}} className='btn-pay' onClick={handleClick}>{btnText}</button>
            </div>
        </section>
    </div>
  )
